...
export const goalValues = {
  [REC_NAMES.POPULARITY]: 0.5, // If less than 50% of the services already existing are popular then rank it less
  [REC_NAMES.RATING]: 4,
  [REC_NAMES.KEYWORDS]: 20,
  [REC_NAMES.POP_SERVICE]: 2,
  [REC_NAMES.EXISTING]: 0.25, // If less than 25% are existing then rank it less
  [REC_NAMES.SERVICE_NUMBER]: 2,
  [REC_NAMES.POP_ZIPCODE]: 1,
...
export const weights = {
  [REC_NAMES.POPULARITY]: 0.3,
  [REC_NAMES.RATING]: 0.15,
  [REC_NAMES.KEYWORDS]: 0.15,
  [REC_NAMES.POP_SERVICE]: 0.2,
...
export const calcResults = {
  left: {
    [REC_NAMES.POPULARITY]: {},
    [REC_NAMES.RATING]: {},
    [REC_NAMES.KEYWORDS]: {},
    [REC_NAMES.POP_SERVICE]: {},
    [REC_NAMES.EXISTING]: {},
  },
  right: {
